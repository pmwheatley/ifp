...
DIRECTORY = alan3_build
HEADER = alan3
DSO = alan-3.0.5.so
ARCHIVE = $(INTERPRETERS)/alansrc3_0alpha5.tgz
...
$(DIRECTORY): $(ARCHIVE)
	mkdir -p $(DIRECTORY)
	cd $(DIRECTORY); \
		gunzip -c <../$(ARCHIVE) | tar xvf - interpreter; \
		patch -i ../$(PATCHES)/alan3.patch -Np1; \
		patch -i ../$(PATCHES)/alan3_checksum.patch -Np1
